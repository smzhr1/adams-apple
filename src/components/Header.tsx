          ...
          <div className="container mx-auto px-4 py-4 space-y-1">
            ...
            {mobileServicesOpen && (
              <div className="pl-4 space-y-1 pb-2">
                {services.map((s) => (
                  <a key={s.label} href={s.href} className="flex items-center gap-2 py-2 text-white/80 text-[15px]">
            ...
            {mobileAreasOpen && (
              <div className="pl-4 space-y-1 pb-2">
                {serviceAreas.map((area) => (
                  <a key={area} href={`/areas/${area.toLowerCase().replace(/\s+/g, '-')}`} className="flex items-center gap-2 py-1.5 text-white/80 text-[15px]">
