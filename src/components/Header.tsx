    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-border shadow-sm">
      <div className="container mx-auto px-4 flex items-center justify-between h-16 md:h-20">
        ...
        <nav className="hidden lg:flex items-center gap-6">
          ...
          <a href="/gallery" className="text-foreground/80 hover:text-primary font-semibold transition-colors text-[15px]">Gallery</a>
          ...
          <a href="/faqs" className="text-foreground/80 hover:text-primary font-semibold transition-colors text-[15px]">FAQs</a>
        </nav>

        <div className="flex items-center gap-3">
          <a href="tel:5129128733" className="hidden md:flex items-center gap-2 text-primary font-bold text-[15px]">
      ...
      {mobileOpen && (
        <div className="lg:hidden bg-background border-t border-border">
          <div className="container mx-auto px-4 py-4 space-y-1">
            ...
            <a href="/gallery" className="block py-3 text-foreground font-bold">Gallery</a>
            ...
            <a href="/faqs" className="block py-3 text-foreground font-bold">FAQs</a>
            <a href="tel:5129128733" className="flex items-center gap-2 py-3 text-primary font-bold">
              <Phone className="w-4 h-4" /> 512-912-8733
            </a>
